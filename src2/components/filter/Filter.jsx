        ...
        >
          <div className="relative">
            ...
            {/* <input
              ...
              className="px-8 py-3 mb-6 flex flex-wrap rounded-md  outline-0 text-sm"
              style={{
            ...
            <input
              ...
              id="searchkey"
              placeholder="Search here"
              className="px-4 py-3 mb-6 flex flex-wrap rounded-md outline-0 text-sm w-full md:w-auto"
              style={{
                backgroundColor: mode === "dark" ? "rgb(64 66 70)" : "",
                color: mode === "dark" ? "white" : "",
              }}
