            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  <br />
                  <Link to={'/tshirt'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Tshirt
                  </Link>
                  ...
                  {user? <div className="flow-root">
                    <Link to={'/dashboard'} className="-m-2 block  p-2 font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '',display:"none" }}>
                      admin
                    </Link>
                  </div> : ""}
            ...
            <div className="flex h-16 items-center">
              ...
              {/* <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>Ashish Nx</h1>
                  </div>
                </Link>
              </div> */}
    ...
    <div className="flex">
      <h1 className='text-2xl font-bold text-black px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '' }}>
        ...
        <span className="hidden sm:inline">
          <img width={'100px'} src="https://logos.textgiraffe.com/logos/logo-name/Kanika-designstyle-smoothie-m.png" />
        </span>
        <span className="sm:hidden">
          <img src="https://logos.textgiraffe.com/logos/logo-name/Kanika-designstyle-smoothie-m.png"  />
        </span>
      </h1>
    </div>
  </Link>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <Link to={'/tshirt'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Tshirt
                  </Link>
                  <Link to={'/hoodie'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Hoodies
                  </Link>
               {/*    <Link to={'/soil'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Soil Testing
                  </Link>
                  <Link to={'/weather'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Whether forecasting
                  </Link> */}
                 ...
                 {user ?  <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {user?.user?.email === 'onlineebook35@gmail.com' ? 
