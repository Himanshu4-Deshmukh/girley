  ...
  return (
    <Layout>
      <header className="bg-blue-500 text-white py-4">
        <h1 className="text-3xl font-semibold mt-16 mb-16 text-center">Privacy Policy</h1>
        <p className="text-center">Updated 16th April 2024</p>
      </header>
      <div className="flex flex-wrap justify-around">
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <p>
            This policy applies to Kanika Playhub Private Limited, a company incorporated under the Companies Act, 1956 with its registered office at 111 BLOCK D1 GALI NO 3, BADARPUR SOUTH, Badarpur (South Delhi), New Delhi, South Delhi- 110044, Delhi, and its Entities/Subsidiaries (collectively “Kanika Playhub”, “we”, “our”, or “us” as the context may require).
          </p>
          <p>
            This policy describes how Kanika Playhub collects, stores, uses, and otherwise processes your Personal Information through Kanika Playhub websites, Kanika Playhub Applications, m-sites, chatbots, notifications, or any other medium used by Kanika Playhub to provide its services to you (hereinafter referred to as the “Platform”). By visiting, downloading, using the Kanika Playhub Platform, and/or providing your information or availing our product/services, you expressly agree to be bound by this Privacy Policy (“Policy”) and the applicable service/product terms and conditions. We value the trust you place in us and respect your privacy, maintaining the highest standards for secure transactions and protection of your personal information.
          </p>
          <p>
          ...
          <p>
            We may collect your Personal Information when you use our services or Platform or otherwise interact with us during the course of our relationship. We collect Personal Information which is relevant and absolutely necessary for providing the services requested by you and to continually improve the Kanika Playhub Platform.
          </p>
          <p>
            Personal and Sensitive Personal Information collected, as applicable, includes, but is not limited to:
          </p>
          <ul className="list-disc list-inside">
            <li>Name, age, gender, photo, address, phone number, email id, your contacts, nominee details</li>
            <li>KYC-related information such as PAN, income details, your business-related information, videos, or other online/offline verification documents as mandated by relevant regulatory authorities</li>
            <li>Aadhaar information including Aadhaar number or Virtual ID for the purposes of e-KYC authentication with the Unique Identification Authority of India (UIDAI). Note that submission of Aadhaar information is not mandatory and there are alternatives to submission of identity information (e.g., Voter ID, DL)</li>
            <li>OTP sent to you by your bank, NSDL, or Kanika Playhub</li>
            <li>Balance including broker ledger balance or margins, transaction history and value, bank account details, wallet balance, investment details and transactions, income range, expense range, investment goals, service or transaction-related communication, order details, service fulfillment details, part of your card details for smooth transaction using Kanika Playhub or any of the services</li>
            <li>Your device details such as device identifier, internet bandwidth, mobile device model, browser plug-ins, and cookies or similar technologies that may identify your browser/Kanika Playhub Applications and plug-ins, and time spent, IP address, and location</li>
            <li>Your Short Messaging Service (SMS(es)) that are stored on your device for the purposes of, including but not limited to, registering you and your device for payments or investment services, OTPs for logins and payments, enhancing your security, bill payments and recharge reminders, and any other legitimate uses with your explicit consent</li>
            <li>Your health and lifestyle-related information, including your physical activity, when you opt for health-tracking services</li>
          </ul>
          <p>
            Information may be collected at various stages of your usage of the Kanika Playhub Platform such as:
          </p>
          <ul className="list-disc list-inside">
            <li>Visiting Kanika Playhub Platform</li>
            <li>Registering on Kanika Playhub Platform as a “user” or “merchant” or any other relationship that may be governed by terms and conditions listed on Kanika Playhub Platform</li>
            <li>Transacting or attempting to transact on Kanika Playhub Platform</li>
            <li>Accessing links, emails, chat conversations, feedbacks, notifications sent or owned by Kanika Playhub Platform and if you opt to participate in our occasional surveys</li>
            <li>Otherwise dealing with any of the Kanika Playhub Entities/Subsidiaries</li>
            <li>While applying for career opportunities with Kanika Playhub</li>
          </ul>
          <p>
          ...
          <ul className="list-disc list-inside">
            <li>Financial history and other information for the purpose of providing you Kanika Playhub services, verifying and authenticating an investment transaction request you place with us to prevent suspicious transactions, or to comply with court judgments and bankruptcies, from credit reference and fraud prevention agencies</li>
            <li>Vehicle-related information</li>
            <li>Your resume, your past employment, and educational qualification for background checks and verifications, through online or offline databases that are otherwise legitimately obtained in case you apply for employment opportunities with Kanika Playhub</li>
          ...
          <h2 className="text-2xl font-semibold mt-6">Purpose and Use of Information</h2>
          <p>
            Kanika Playhub may process your Personal Information for the following purposes:
          </p>
          <ul className="list-disc list-inside">
            <li>Creation of your account and verification of your identity and access privileges</li>
            <li>Provide you access to the products and services being offered by us, merchants, registered investment advisors, research analysts, entities, subsidiaries, sellers, logistic partners, or business partners</li>
            <li>Fulfill your service request</li>
            ...
            <li>To facilitate the offer of services and enable communications to you by WealthBasket curators for purchase and sale transactions of Wealthbaskets by you</li>
            ...
            <li>Enhancing your user experience in various processes/submission of applications/availment of product/service offerings by analyzing user behavior on an aggregated basis</li>
            ...
            <li>To allow third parties to contact you for products and services availed/requested by you on Kanika Playhub Platform or third-party links</li>
            <li>To carry out credit checks, screenings, or due diligence checks as lawfully required by us and detect and protect us against error, fraud, money laundering, and other criminal activity</li>
            ...
            <li>To identify security breaches and attacks; investigating, preventing, and taking action on illegal or suspected fraud or money laundering activities and conducting forensic audits as part of internal or external audit or investigation by Kanika Playhub or government agencies located within India or outside the Indian jurisdiction</li>
          ...
          <h2 className="text-2xl font-semibold mt-6">Cookies or Similar Technologies</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-6">Information Sharing and Disclosures</h2>
          <p>
          ...
          <ul className="list-disc list-inside">
            <li>For enabling the provision of the products/services availed by you and facilitating the services between you and the service provider, registered investment advisors, research analysts, sellers, logistic partners, as requested</li>
            ...
            <li>For enabling your lending journey by sharing information with authorized financial institutions with whom we partner to offer you credit-related products and services. We may also share your information with third parties under contract who assist us with our business operations, including enabling your KYC process, eligibility checks, collection services, and storage of such information, as required by our lending partners</li>
            ...
            <li>Respond to claims that an advertisement, posting, or other content violates the rights of a third party; or protect the rights, property or personal safety of our users or the general public</li>
            ...
            <li>With the internal investigation department within Kanika Playhub or agencies appointed by Kanika Playhub for investigation purposes located within or outside the Indian jurisdiction</li>
          ...
          <h2 className="text-2xl font-semibold mt-6">Reasonable Security Practices</h2>
          <p>
            Kanika Playhub has deployed administrative, technical, and physical security measures to safeguard the user’s Personal Information and Sensitive Personal Information. Specifically, in order to safeguard your Aadhaar information, we have implemented applicable security controls as given under and required by the Aadhaar Regulations. We understand that as effective as our security measures are, no security system is impenetrable. Hence, as part of our reasonable security practices, we undergo strict internal and external reviews to ensure appropriate information security encryption or controls are placed for both data in motion and data at rest within our network and servers respectively. The database is stored on servers secured behind a firewall; access to the servers is password-protected and is strictly limited.
          </p>
          <p>
            Further, you are responsible for maintaining the confidentiality and security of your login id and password. Please do not share your Kanika Playhub login, password, and OTP details with anybody. It shall be your responsibility to intimate us in case of any actual or suspected compromise to your Personal Information.
          </p>
          <p>
            We have provided multiple levels of security to safeguard the Kanika Playhub Application by login/logout option and Kanika Playhub Application lock feature (“Enable Screen Lock”) that can be enabled by you. We have preventive controls implemented to ensure you use Kanika Playhub Application on your device and the same login credentials cannot be used on a different device without any additional authentication/OTP.
          </p>

          <h2 className="text-2xl font-semibold mt-6">Third-Party Products, Services, or Websites</h2>
          <p>
            When you are availing products and services of service providers on Kanika Playhub Platform, Personal Information may be collected by respective service providers and such Personal Information shall be governed by their privacy policy. You may refer to their privacy policy and terms of service to understand how your Personal Information will be handled by such service providers.
          </p>
          <p>
            Our services may include links to other websites or applications when you visit our Platform. Such websites or applications are governed by their respective privacy policies, which are beyond our control. Once you leave our servers (you can tell where you are by checking the URL in the location bar on your browser or on the m-site you are redirected to), use of any Personal Information that you provide on these websites or applications is governed by the privacy policy of the operator of the application/website you are visiting. That policy may differ from ours and you are requested to review those policies or seek access to the policies from the domain owner before proceeding to use those applications or websites. We do not accept any responsibility or liability for the usage of your Personal Information by these third parties or their policies.
          </p>

          <h2 className="text-2xl font-semibold mt-6">Your Consent</h2>
          <p>
            We process your Personal Information with consent. By using the Kanika Playhub Platform or services and/or by providing your Personal Information, you consent to the processing of your Personal Information by Kanika Playhub in accordance with this Privacy Policy. If you disclose to us any Personal Information relating to other people, you represent that you have the authority to do so and permit us to use the information in accordance with this Privacy Policy. Further, you agree and authorize Kanika Playhub to communicate with you via channels like Phone calls and E-mail for the purposes set out in this policy, irrespective of your registration with any authorized DND registries.
          </p>

          <h2 className="text-2xl font-semibold mt-6">Choice/Opt-out</h2>
          <p>
          ...
          <p>
            In case you receive a call for any specific Kanika Playhub product/service you may opt-out from such calls by informing Kanika Playhub’s representative during the call.
          </p>

          <h2 className="text-2xl font-semibold mt-6">Personal Information Access/Rectification and Consent</h2>
          <p>
          ...
          <p>
            In case you wish to delete your account or Personal Information, please use the ‘Help’ section of the Kanika Playhub Platform. However, retention of your Personal Information will be subject to applicable laws.
          </p>
          <p>
            For the above requests, Kanika Playhub may need to request specific information from you to confirm your identity and ensure authentication. This is a security measure to ensure that Personal Information is not disclosed to any person who does not have a right to receive it or is not incorrectly modified or deleted.
          </p>
          <p>
            In cases where you need any further information specific to the product/services that you are availing, we request you to read through the Terms and Conditions specific to the product/service which is easily accessible through the Kanika Playhub Platform. For seeking any further information on the same, you can write to us at the details mentioned in the ‘Contact Us’ section of this Policy.
          </p>

          <h2 className="text-2xl font-semibold mt-6">Children Information</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-6">Changes to Policy</h2>
          <p>
          ...
          <p>
            In case you have any questions, concerns, or complaints regarding the processing of your Personal Information or this Privacy Policy you may write to Kanika Playhub’s Privacy Officer using this link <a href="https://support.phonepe.com" className="text-blue-500 underline">https://support.phonepe.com</a>. We are committed to answering your questions within a reasonable time limit. Any delay in the resolution time shall be proactively communicated to you.
          </p>
        </div>
      </div>
    </Layout>
