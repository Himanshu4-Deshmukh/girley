    ...
    <Layout>
      ...
      <div className="flex flex-wrap justify-around">
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <ul>
            <li>name, age, gender, photo, address, phone number, e-mail id, your contacts, nominee details</li>
          ...
          <h2>Cookies or Similar Technologies</h2>
          <p>
          ...
          <h2>Personal Information Access/Rectification and Consent</h2>
          <p>
          ...
          <h2>Contact Us</h2>
          <p>
            In case you have any questions, concerns, or complaints regarding the processing of your Personal Information or this Privacy Policy you may write to Kanika Playhub’s Privacy Officer using this link support@kanikaplayhub.com. We are committed to answer your questions within the reasonable time limit. Any delay in the resolution time shall be proactively communicated to you.
          </p>
        </div>
      </div>
    </Layout>
