    ...
    <Layout>
      ...
      <div className="flex flex-wrap justify-around mt-8">
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <p>For any specific details regarding shipping, please contact us at <a href="mailto:orders@kanikaplayhub.com">orders@kanikaplayhub.com</a>.</p>

          <h2>What if a product is currently out of stock in the size I want?</h2>
          <p>We usually replenish our stock as soon as possible. You can leave your email address in the dialogue box that pops up when you try to add an item that's out of stock to your cart to receive an email notification as soon as it's back in stock. Drop us an email at <a href="mailto:orders@kanikaplayhub.com">orders@kanikaplayhub.com</a> if you have any questions.</p>

          <h2>What if I need an urgent delivery?</h2>
          <p>Please get in touch with us at <a href="mailto:orders@kanikaplayhub.com">orders@kanikaplayhub.com</a> and we will be happy to help you out.</p>

          <h2>Do you ship internationally?</h2>
          <p>Not at the moment.</p>

          <h2>What are the charges for a bulk order?</h2>
          <p>Please contact us at <a href="mailto:contact@kanikaplayhub.com">contact@kanikaplayhub.com</a> with your queries.</p>
        </div>
      </div>
    </Layout>
  );
